...
";
    ...
    <ul id=\"";
        ...
        if ((array_key_exists("collection", $context) && (twig_length_filter($this->env, ($context["collection"] ?? $this->getContext($context, "collection"))) > 0))) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                ...
                echo "\" class=\"col-xl-4 col-lg-6 mb-1\">
    ...
    <div class=\"row mb-2\">
        ...
        echo "-curPackItemQty').val();
                        ...
                        var html = '<li data-product=\"' + data.id + '-' + (data.id_product_attribute ? data.id_product_attribute : 0) + '\" class=\"col-xl-4 col-lg-6 mb-1\">';
...
{% block typeahead_product_pack_collection_widget %}
    ...
    <ul id=\"{{ form.vars.id }}-data\" class=\"typeahead-list pack nostyle row\">
        {% if collection is defined and collection|length > 0 %}
            {% for item in collection %}
                <li data-product=\"{{ item.id }}-{{ item.id_product_attribute }}\" class=\"col-xl-4 col-lg-6 mb-1\">
                    <div class=\"pack-product\">
...
{% endblock %}
", "@PrestaShop/Admin/TwigTemplateForm/typeahead.html.twig", "/home/forge/aryova.com/src/PrestaShopBundle/Resources/views/Admin/TwigTemplateForm/typeahead.html.twig");
    }
}
