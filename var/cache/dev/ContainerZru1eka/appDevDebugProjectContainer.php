...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('kLAZzNQCzt', 0, ($this->targetDirs[0].'/pools'));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => '146.190.28.253', 'port' => '', 'dbname' => 'aryova_main_database', 'user' => 'super', 'password' => 'GSDhoiye@%$%lkjdslf32', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'defaultTableOptions' => []], $a, $c, ['enum' => 'string']);
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('O5xmFqhAQk', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dU4XYPWhfl', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Zw1Hg2q-Is', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('DaZF5HNQpFNEhUkw2eqm89gjfPekvh6m8ET5qrA61sZdADQrAivcpOHJx3Vcc0eq'))) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('DaZF5HNQpFNEhUkw2eqm89gjfPekvh6m8ET5qrA61sZdADQrAivcpOHJx3Vcc0eq');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'modules_translation_paths': $value = [
                ...
                33 => ($this->targetDirs[3].'/modules/statsforecast/translations'),
                34 => ($this->targetDirs[3].'/modules/statsnewsletter/translations'),
                35 => ($this->targetDirs[3].'/modules/statspersonalinfos/translations'),
                36 => ($this->targetDirs[3].'/modules/statsproduct/translations'),
                37 => ($this->targetDirs[3].'/modules/statsregistrations/translations'),
                38 => ($this->targetDirs[3].'/modules/statssales/translations'),
                39 => ($this->targetDirs[3].'/modules/statssearch/translations'),
                40 => ($this->targetDirs[3].'/modules/statsstock/translations'),
                41 => ($this->targetDirs[3].'/modules/gamification/translations'),
                42 => ($this->targetDirs[3].'/modules/psaddonsconnect/translations'),
                43 => ($this->targetDirs[3].'/modules/psgdpr/translations'),
                44 => ($this->targetDirs[3].'/modules/psxmarketingwithgoogle/translations'),
                45 => ($this->targetDirs[3].'/modules/blockreassurance/translations'),
                46 => ($this->targetDirs[3].'/modules/ps_cashondelivery/translations'),
                47 => ($this->targetDirs[3].'/modules/ps_accounts/translations'),
                48 => ($this->targetDirs[3].'/modules/ht_staticblocks/translations'),
                49 => ($this->targetDirs[3].'/modules/ht_brandlist/translations'),
                50 => ($this->targetDirs[3].'/modules/ps_viewedproduct/translations'),
                51 => ($this->targetDirs[3].'/modules/ps_categoryproducts/translations'),
                52 => ($this->targetDirs[3].'/modules/binshopsrest/translations'),
                ...
                56 => ($this->targetDirs[3].'/modules/ps_featuredproducts/translations'),
                57 => ($this->targetDirs[3].'/modules/ps_metrics/translations'),
                58 => ($this->targetDirs[3].'/modules/ps_facebook/translations'),
            ]; break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.secret' => 'DaZF5HNQpFNEhUkw2eqm89gjfPekvh6m8ET5qrA61sZdADQrAivcpOHJx3Vcc0eq',
