    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'modules_translation_paths': $value = [
                ...
                60 => ($this->targetDirs[3].'/modules/ps_viewedproduct/translations'),
                61 => ($this->targetDirs[3].'/modules/ps_categoryproducts/translations'),
                62 => ($this->targetDirs[3].'/modules/binshopsrest/translations'),
            ]; break;
